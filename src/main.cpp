...
void setup() {
  ...
  // configTime(0, 0, nullptr); // Basic time system init for ESP8266. (TZ, offset, ntp server)
                               // settimeofday should work without this for manual setting.
...
void checkScheduledEvents() {
  ...
  // Solenoid 1 Schedule
  if (solenoid1Settings.scheduleEnabled &&
      timeinfo.tm_hour == solenoid1Settings.scheduleHour &&
    ...
    last_run_day[0] = timeinfo.tm_yday;
  }

  // Solenoid 2 Schedule
  if (solenoid2Settings.scheduleEnabled &&
      timeinfo.tm_hour == solenoid2Settings.scheduleHour &&
    ...
    last_run_day[1] = timeinfo.tm_yday;
  }

  // Solenoid 3 Schedule
  if (solenoid3Settings.scheduleEnabled &&
      timeinfo.tm_hour == solenoid3Settings.scheduleHour &&
    ...
    last_run_day[2] = timeinfo.tm_yday;
  }
}
...
<head>
  ...
  <style>
    ...
    .checkbox-label { width: auto; font-weight: normal; }
    ...
    <form id="settingsForm">
      <div class="solenoid-group">
        ...
        <div class="setting-row">
          ...
          <label for="solenoid1SchedEnabled" class="checkbox-label">Enable</label>
        </div>
      </div>
      ...
      <div class="solenoid-group">
        ...
        <div class="setting-row">
          ...
          <label for="solenoid2SchedEnabled" class="checkbox-label">Enable</label>
        </div>
      </div>
      ...
      <div class="solenoid-group">
        ...
        <div class="setting-row">
          ...
          <label for="solenoid3SchedEnabled" class="checkbox-label">Enable</label>
        </div>
      </div>
